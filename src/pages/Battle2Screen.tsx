...
const Battle2Screen: React.FC = () => {
  const { bgmEnabled, toggleBgm, opponent2 } = useApp();
  const {
    player,
    opponent,
    battleTimer,
  ...
  // BGM URLs
  const battleBgmUrl = "https://soundcloud.com/davis-momoyama/yuji/s-eRNyylMU23D?in=davis-momoyama/sets/battlefm/s-NbrA67b7tx5";
  ...
  return (
    <div 
      ...
      style={{ 
        background: 'linear-gradient(180deg, rgba(90, 90, 180, 1), rgba(40, 40, 120, 1))',
