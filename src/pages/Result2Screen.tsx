...
const Result2Screen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Store defeat status for EndingC screen
  ...
  return (
    ...
    >
      {/* Main content - centered vertically with modified positioning */}
      <div className="w-full flex flex-col items-center justify-center flex-1">
        {/* Live ended text - positioned lower */}
        <div className="text-center mb-6 translate-y-[20%]">
          ...
          {/* Comment count - updated to show total comments including system comments */}
